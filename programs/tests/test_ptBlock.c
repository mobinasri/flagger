...
int main(int argc, char *argv[]) {
   ...
   // test 6
   bool test_ptBlock_print_headers_stList_compressed_passed = test_ptBlock_print_headers_stList_compressed("tests/test_files/test_header_1.cov.gz");
   ...
   // test 7
   bool test_ptBlock_print_headers_stList_uncompressed_passed = test_ptBlock_print_headers_stList_uncompressed("tests/test_files/test_header_1.cov");
   ...
   // test 8
   bool test_ptBlock_create_and_print_headers_uncompressed_passed = test_ptBlock_create_and_print_headers_uncompressed("tests/test_files/test_header_2.cov");
