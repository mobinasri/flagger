...
bool test_CoverageInfo_getStartingAnnotationIndices() {
    bool correct = true;
    ...
    int len = -1;
    int *startingIndices = CoverageInfo_getStartingAnnotationIndices(prev, curr, &len);
    if (len != 2) return false;
    correct &= (startingIndices[0] == 6) && (startingIndices[1] == 8);
...
int main(int argc, char *argv[]) {
    ...
    // test 6
    bool test_CoverageInfo_getStartingAnnotationIndices_passed = test_CoverageInfo_getStartingAnnotationIndices();
    all_tests_passed &= test_CoverageInfo_getStartingAnnotationIndices_passed;
